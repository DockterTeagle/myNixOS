...
declare module "gi://Astal?version=3.0" {
  ...
  export namespace Astal {
    ...
    function widget_set_class_names(
      widget: Gtk.Widget,
      class_names: string[],
    ): void;
    function widget_get_class_names(widget: Gtk.Widget): string[];
    function widget_toggle_class_name(
      widget: Gtk.Widget,
      class_name: string,
      condition: boolean,
    ): void;
    ...
    function widget_set_click_through(
      widget: Gtk.Widget,
    ...
    class Button extends Gtk.Button {
      ...
      constructor(
        properties?: Partial<Button.ConstructorProps>,
        ...args: any[]
      );
      ...
      connect(
        signal: "hover",
        callback: (_source: this, event: HoverEvent) => void,
      ): number;
      connect_after(
        signal: "hover",
        callback: (_source: this, event: HoverEvent) => void,
      ...
      connect(
        signal: "click",
        callback: (_source: this, event: ClickEvent) => void,
      ): number;
      connect_after(
        signal: "click",
        callback: (_source: this, event: ClickEvent) => void,
      ...
      connect(
        signal: "scroll",
        callback: (_source: this, event: ScrollEvent) => void,
      ): number;
      connect_after(
        signal: "scroll",
        callback: (_source: this, event: ScrollEvent) => void,
    ...
    class CenterBox extends Gtk.Box {
      ...
      constructor(
        properties?: Partial<CenterBox.ConstructorProps>,
        ...args: any[]
      );
    ...
    class CircularProgress extends Gtk.Bin {
      ...
      constructor(
        properties?: Partial<CircularProgress.ConstructorProps>,
        ...args: any[]
      );
    ...
    class EventBox extends Gtk.EventBox {
      ...
      constructor(
        properties?: Partial<EventBox.ConstructorProps>,
        ...args: any[]
      );
      ...
      connect(
        signal: "motion",
        callback: (_source: this, event: MotionEvent) => void,
      ): number;
      connect_after(
        signal: "motion",
        callback: (_source: this, event: MotionEvent) => void,
    ...
    class LevelBar extends Gtk.LevelBar {
      ...
      constructor(
        properties?: Partial<LevelBar.ConstructorProps>,
        ...args: any[]
      );
    ...
    class Overlay extends Gtk.Overlay {
      ...
      constructor(
        properties?: Partial<Overlay.ConstructorProps>,
        ...args: any[]
      );
    ...
    class Scrollable extends Gtk.ScrolledWindow {
      ...
      constructor(
        properties?: Partial<Scrollable.ConstructorProps>,
        ...args: any[]
      );
    ...
    class Slider extends Gtk.Scale {
      ...
      constructor(
        properties?: Partial<Slider.ConstructorProps>,
        ...args: any[]
      );
    ...
    module Application {
      ...
      interface ConstructorProps
        extends
          ...
          AstalIO.Application.ConstructorProps {
    ...
    class Application extends Gtk.Application implements AstalIO.Application {
      ...
      constructor(
        properties?: Partial<Application.ConstructorProps>,
        ...args: any[]
      );
      ...
      connect(
        ...
        callback: (_source: this, monitor: Gdk.Monitor) => void,
      ): number;
      connect_after(
        signal: "monitor-added",
        callback: (_source: this, monitor: Gdk.Monitor) => void,
      ...
      connect(
        ...
        callback: (_source: this, window: Gtk.Window) => void,
      ): number;
      connect_after(
        signal: "window-toggled",
        callback: (_source: this, window: Gtk.Window) => void,
