...
declare module "gi://AstalIO?version=0.1" {
  ...
  export namespace AstalIO {
    ...
    class Process extends GObject.Object {
      ...
      constructor(
        properties?: Partial<Process.ConstructorProps>,
        ...args: any[]
      );
      ...
      connect(
        signal: "stdout",
        callback: (_source: this, out: string) => void,
      ): number;
      connect_after(
        signal: "stdout",
        callback: (_source: this, out: string) => void,
      ...
      connect(
        signal: "stderr",
        callback: (_source: this, err: string) => void,
      ): number;
      connect_after(
        signal: "stderr",
        callback: (_source: this, err: string) => void,
      ...
      static exec_asyncv(
        cmd: string[],
        _callback_?: Gio.AsyncReadyCallback<Process> | null,
      ): void;
    ...
    class Time extends GObject.Object {
      ...
      static interval_prio(
        interval: number,
        prio: number,
        fn?: GObject.Closure | null,
      ): Time;
    ...
    class VariableBase extends GObject.Object {
      ...
      constructor(
        properties?: Partial<VariableBase.ConstructorProps>,
        ...args: any[]
      );
    ...
    class Variable extends VariableBase {
      ...
      constructor(
        properties?: Partial<Variable.ConstructorProps>,
        ...args: any[]
      );
      ...
      poll(
        interval: number,
        exec: string,
        transform?: GObject.Closure | null,
      ): Variable;
      pollv(
        interval: number,
        execv: string[],
