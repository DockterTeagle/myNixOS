...
declare module "gi://Gdk?version=3.0" {
  ...
  export namespace Gdk {
    ...
    abstract class DeviceManager extends GObject.Object {
      ...
      constructor(
        properties?: Partial<DeviceManager.ConstructorProps>,
        ...args: any[]
      );
    ...
    class DragContext extends GObject.Object {
      ...
      constructor(
        properties?: Partial<DragContext.ConstructorProps>,
        ...args: any[]
      );
      ...
      connect(
        ...
        callback: (_source: this, action: DragAction) => void,
      ): number;
      connect_after(
        signal: "action-changed",
        callback: (_source: this, action: DragAction) => void,
      ...
      connect(
        ...
        callback: (_source: this, time: number) => void,
      ): number;
      connect_after(
        signal: "drop-performed",
        callback: (_source: this, time: number) => void,
    ...
    class DrawingContext extends GObject.Object {
      ...
      constructor(
        properties?: Partial<DrawingContext.ConstructorProps>,
        ...args: any[]
      );
    ...
    class Keymap extends GObject.Object {
      ...
      constructor(
        properties?: Partial<Keymap.ConstructorProps>,
        ...args: any[]
      );
    ...
    class Screen extends GObject.Object {
      ...
      constructor(
        properties?: Partial<Screen.ConstructorProps>,
        ...args: any[]
      );
    ...
    class Visual extends GObject.Object {
      ...
      constructor(
        properties?: Partial<Visual.ConstructorProps>,
        ...args: any[]
      );
    ...
    abstract class Window extends GObject.Object {
      ...
      constructor(
        properties?: Partial<Window.ConstructorProps>,
        ...args: any[]
      );
      ...
      get_device_position(
        device: Device,
      ): [Window | null, number, number, ModifierType | null];
      /**
