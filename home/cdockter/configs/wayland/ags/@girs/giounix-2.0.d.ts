...
declare module "gi://GioUnix?version=2.0" {
  ...
  export namespace GioUnix {
     ...
     */
    function file_descriptor_based_get_fd(
     ...
     */
    function mount_guess_should_display(
      mount_entry: Gio.UnixMountEntry,
    ): boolean;
    /**
     ...
     * @returns a #GIcon
     */
    function mount_guess_symbolic_icon(
      mount_entry: Gio.UnixMountEntry,
    ): Gio.Icon;
    /**
     ...
     */
    function mount_point_at(
      mount_path: string,
    ): [Gio.UnixMountPoint | null, number];
    /**
     ...
     * @returns 1, 0 or -1 if @mount1 is greater than, equal to, or less than @mount2, respectively.
     */
    function mount_point_compare(
      mount1: Gio.UnixMountPoint,
      mount2: Gio.UnixMountPoint,
    ): number;
    /**
     ...
     */
    function mount_point_copy(
      mount_point: Gio.UnixMountPoint,
    ): Gio.UnixMountPoint;
    /**
     ...
     * @returns a string containing the device path.
     */
    function mount_point_get_device_path(
      mount_point: Gio.UnixMountPoint,
    ): string;
    /**
     ...
     */
    function mount_point_get_mount_path(
      mount_point: Gio.UnixMountPoint,
    ): string;
    /**
     ...
     */
    function mount_point_get_options(
      mount_point: Gio.UnixMountPoint,
    ): string | null;
    /**
     ...
     */
    function mount_point_guess_can_eject(
      mount_point: Gio.UnixMountPoint,
    ): boolean;
    /**
     ...
     * @returns a #GIcon
     */
    function mount_point_guess_symbolic_icon(
      mount_point: Gio.UnixMountPoint,
    ): Gio.Icon;
    /**
     ...
     */
    function mount_point_is_user_mountable(
      mount_point: Gio.UnixMountPoint,
    ): boolean;
    /**
     ...
     */
    function mount_points_get_from_file(
      table_path: string,
    ): [Gio.UnixMountPoint[] | null, number];
    /**
     ...
     */
    function mounts_get_from_file(
      table_path: string,
    ): [Gio.UnixMountEntry[] | null, number];
    ...
    module DesktopAppInfo {
      ...
      interface ConstructorProps
        extends GObject.Object.ConstructorProps, Gio.AppInfo.ConstructorProps {
        filename: string;
      }
    }
    ...
    class DesktopAppInfo extends GObject.Object implements Gio.AppInfo {
      ...
      constructor(
        properties?: Partial<DesktopAppInfo.ConstructorProps>,
        ...args: any[]
      );
    ...
    module FDMessage {
      ...
      interface ConstructorProps
        extends Gio.SocketControlMessage.ConstructorProps {
    ...
    class FDMessage extends Gio.SocketControlMessage {
      ...
      constructor(
        properties?: Partial<FDMessage.ConstructorProps>,
        ...args: any[]
      );
    ...
    class InputStream extends Gio.InputStream
      ...
      constructor(
        properties?: Partial<InputStream.ConstructorProps>,
        ...args: any[]
      );
    ...
    class MountMonitor extends GObject.Object {
      ...
      constructor(
        properties?: Partial<MountMonitor.ConstructorProps>,
        ...args: any[]
      );
    ...
    class OutputStream extends Gio.OutputStream
      ...
      constructor(
        properties?: Partial<OutputStream.ConstructorProps>,
        ...args: any[]
      );
