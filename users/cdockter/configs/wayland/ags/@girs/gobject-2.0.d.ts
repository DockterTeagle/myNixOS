...
declare module "gi://GObject?version=2.0" {
  ...
  export namespace GObject {
    ...
    export type Property<K extends ParamSpec> = K extends ParamSpec<infer T> ? T
      : any;
    ...
    function type_init_with_debug_flags(
      debug_flags: TypeDebugFlags | null,
    ): void;
    /**
    ...
    class Binding extends Object {
      ...
      constructor(
        properties?: Partial<Binding.ConstructorProps>,
        ...args: any[]
      );
    ...
    class BindingGroup extends Object {
      ...
      constructor(
        properties?: Partial<BindingGroup.ConstructorProps>,
        ...args: any[]
      );
    ...
    class InitiallyUnowned extends Object {
      ...
      constructor(
        properties?: Partial<InitiallyUnowned.ConstructorProps>,
        ...args: any[]
      );
    ...
    class Object {
      ...
      connect(
        signal: "notify",
        callback: (_source: this, pspec: ParamSpec) => void,
      ): number;
      connect_after(
        signal: "notify",
        callback: (_source: this, pspec: ParamSpec) => void,
    ...
    class SignalGroup extends Object {
      ...
      constructor(
        properties?: Partial<SignalGroup.ConstructorProps>,
        ...args: any[]
      );
      ...
      connect(
        signal: "bind",
        callback: (_source: this, instance: Object) => void,
      ): number;
      connect_after(
        signal: "bind",
        callback: (_source: this, instance: Object) => void,
    ...
    module TypeModule {
      ...
      interface ConstructorProps
        extends Object.ConstructorProps, TypePlugin.ConstructorProps {}
    }
    ...
    abstract class TypeModule extends Object implements TypePlugin {
      ...
      constructor(
        properties?: Partial<TypeModule.ConstructorProps>,
        ...args: any[]
      );
    ...
    function signal_handlers_unblock_by_func(
      instance: Object,
      func: (...args: any[]) => any,
    ): void;
