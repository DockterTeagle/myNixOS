...
declare module "gi://HarfBuzz?version=0.0" {
  ...
  export namespace HarfBuzz {
    ...
    function buffer_set_cluster_level(
      buffer: buffer_t,
      cluster_level: buffer_cluster_level_t | null,
    ): void;
    /**
    ...
    function buffer_set_content_type(
      buffer: buffer_t,
      content_type: buffer_content_type_t | null,
    ): void;
    /**
    ...
    function map_next(
      map: map_t,
      idx: number,
    ): [bool_t, number, codepoint_t, codepoint_t];
    /**
    ...
    function ot_layout_get_glyphs_in_class(
      face: face_t,
      klass: ot_layout_glyph_class_t | null,
    ): set_t;
    /**
    ...
    function ot_layout_get_size_params(
      face: face_t,
    ): [bool_t, number, number, ot_name_id_t, number, number];
    /**
    ...
    function ot_math_get_constant(
      font: font_t,
      constant: ot_math_constant_t | null,
    ): position_t;
    /**
    ...
    function set_next_range(
      set: set_t,
      last: codepoint_t,
    ): [bool_t, codepoint_t, codepoint_t];
    /**
