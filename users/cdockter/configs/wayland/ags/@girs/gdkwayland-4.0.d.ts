...
declare module "gi://GdkWayland?version=4.0" {
  ...
  export namespace GdkWayland {
    ...
    class WaylandDevice extends Gdk.Device {
      ...
      constructor(
        properties?: Partial<WaylandDevice.ConstructorProps>,
        ...args: any[]
      );
    ...
    class WaylandDisplay extends Gdk.Display {
      ...
      constructor(
        properties?: Partial<WaylandDisplay.ConstructorProps>,
        ...args: any[]
      );
    ...
    class WaylandGLContext extends Gdk.GLContext {
      ...
      constructor(
        properties?: Partial<WaylandGLContext.ConstructorProps>,
        ...args: any[]
      );
    ...
    class WaylandMonitor extends Gdk.Monitor {
      ...
      constructor(
        properties?: Partial<WaylandMonitor.ConstructorProps>,
        ...args: any[]
      );
    ...
    module WaylandPopup {
      ...
      interface ConstructorProps
        extends WaylandSurface.ConstructorProps, Gdk.Popup.ConstructorProps {}
    }
    ...
    class WaylandPopup extends WaylandSurface implements Gdk.Popup {
      ...
      constructor(
        properties?: Partial<WaylandPopup.ConstructorProps>,
        ...args: any[]
      );
      ...
      get_device_position(
        device: Gdk.Device,
      ): [boolean, number, number, Gdk.ModifierType | null];
      /**
    ...
    class WaylandSeat extends Gdk.Seat {
      ...
      constructor(
        properties?: Partial<WaylandSeat.ConstructorProps>,
        ...args: any[]
      );
    ...
    class WaylandSurface extends Gdk.Surface {
      ...
      constructor(
        properties?: Partial<WaylandSurface.ConstructorProps>,
        ...args: any[]
      );
    ...
    module WaylandToplevel {
      ...
      interface ConstructorProps
        extends
          WaylandSurface.ConstructorProps,
          Gdk.Toplevel.ConstructorProps {}
    }
    ...
    class WaylandToplevel extends WaylandSurface implements Gdk.Toplevel {
      ...
      constructor(
        properties?: Partial<WaylandToplevel.ConstructorProps>,
        ...args: any[]
      );
